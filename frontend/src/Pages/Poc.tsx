...
const borrowingRequestRows: GridRowsProp = [
  { id: 1, borrowingAmount: 1000, duration: 30, interestRate: 5, collateral: 500, status: 'Waiting', borrower: 'Alice', lender: 'Bob', startDate: '2021-10-01' },
  { id: 2, borrowingAmount: 2000, duration: 60, interestRate: 6, collateral: 1100, status: 'Progress', borrower: 'Bob', lender: 'Alice', startDate: '2021-10-02' },
  { id: 3, borrowingAmount: 3000, duration: 90, interestRate: 7, collateral: 1500, status: 'Paid', borrower: 'Charlie', lender: 'Alice', startDate: '2021-10-03' },
  { id: 4, borrowingAmount: 4000, duration: 120, interestRate: 8, collateral: 2500, status: 'Defaulted', borrower: 'David', lender: 'Bob', startDate: '2021-10-04' },
  { id: 5, borrowingAmount: 5000, duration: 150, interestRate: 9, collateral: 2500, status: 'Waiting', borrower: 'Eve', lender: 'Alice', startDate: '2021-10-05' },
  { id: 6, borrowingAmount: 5000, duration: 150, interestRate: 9, collateral: 2200, status: 'Cancelled', borrower: 'Eve', lender: 'Alice', startDate: '2021-10-05' },
];

const BorrowingRequestTable: React.FC = () => {
  ...
  const filteredRows = borrowingRequestRows.filter((row) => {
    return (
      ...
      (durationCondition === '' || (durationCondition === 'greater' && row.duration > parseInt(durationFilter)) ||
        (durationCondition === 'less' && row.duration < parseInt(durationFilter)) ||
        (durationCondition === 'equal' && row.duration === parseInt(durationFilter))) &&
      (interestRateCondition === '' || (interestRateCondition === 'greater' && row.interestRate > parseInt(interestRateFilter)) ||
      ...
      (collateralCondition === '' || (collateralCondition === 'greater' && row.collateral > parseInt(collateralFilter)) ||
...
export default BorrowingRequestTable;